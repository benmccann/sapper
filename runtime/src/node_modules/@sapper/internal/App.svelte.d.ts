...
export type BrowserAppPropsUpdate<L1> = Omit<BrowserAppPropsInit<never, L1>, 'notify' | 'level0'>

export type AppProps<L1> = BrowserAppPropsUpdate<L1> & Omit<SSRAppPropsRender<never, L1>, 'notify' | 'level0'>
